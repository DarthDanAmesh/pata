...
public class EmployeeModel {
    ...
    private SimpleBooleanProperty permanent_status;
    ...
    public EmployeeModel() {
        ...
        this.permanent_status = new SimpleBooleanProperty();
    }
    //employee_id
    ...
    public SimpleBooleanProperty permanent_status(boolean workingPermanent){
